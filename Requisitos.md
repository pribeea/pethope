...
RF01 – Cadastrar ONG
- O sistema deve permitir que ONGs criem seu registro, informando dados essenciais;
...
RF04 – Gerenciar Adoções
- O sistema deve permitir:
- Solicitar adoção;
- Armazenar dados do adotante;
- Registrar pedidos de adoção;
